  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-8 sm:pb-10 border-b border-white/10">
        ...
        <div className="pt-10 sm:pt-14 pb-12 sm:pb-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 sm:space-y-8">
              ...
              {/* Verified Technical Telemetry Row (Clean Monospace Strip, zero card clutter) */}
              ...
              <div className="pt-2 sm:pt-4">
                <Link
                  ...
                  className="inline-flex items-center gap-3 bg-[#c42f0b] hover:bg-[#a82506] active:bg-[#8f1f04] text-white font-semibold text-xs sm:text-sm px-6 sm:px-8 py-3.5 sm:py-4 rounded-full transition-colors duration-150 shadow-xl shadow-[#c42f0b]/25 focus:outline-none focus-visible:ring-2 focus-visible:ring-white"
                >
            ...
            <div className="lg:col-span-5 flex flex-col items-start lg:items-end">
              <div
                ref={metricCardRef}
                className="relative bg-white/[0.04] border border-white/12 p-6 sm:p-9 rounded-2xl backdrop-blur-md w-full max-w-md shadow-2xl space-y-5"
              >
                {/* Metric Header */}
                <div className="flex items-center justify-between border-b border-white/10 pb-3 text-xs font-mono">
                  <span className="text-[10px] tracking-[0.2em] text-[#ff6b4a] uppercase font-bold">
                ...
                <div className="space-y-1">
                  <div className="text-5xl sm:text-7xl font-black text-white tracking-tighter leading-none">
